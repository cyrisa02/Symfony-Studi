...
/* user/list.html.twig */
class __TwigTemplate_20f92b438b91db8512ec75a0727c7424ff0dc7d5409e6e9309c4a3eed927c308 extends Template
{
    private $source;
    private $macros = [];
...
<h1>Les Utilisateurs</h1>
    <ul>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            // line 13
            echo "            <li><a href=\"";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("user_item", ["id" => twig_get_attribute($this->env, $this->source, $context["loop"], "index0", [], "any", false, false, false, 13)]), "html", null, true);
            echo "\">";
    ...
    {
        return array (  89 => 15,  70 => 13,  53 => 12,  40 => 1,);
    }
...
<h1>Les Utilisateurs</h1>
    <ul>
            {% for user in users %}
            <li><a href=\"{{ path('user_item', { id: loop.index0 }) }}\">{{ user.name }}</a></li>
            {% endfor %}
        </ul>
</body>
</html>", "user/list.html.twig", "/home/cyril/Bureau/exsymf/templates/user/list.html.twig");
    }
}
