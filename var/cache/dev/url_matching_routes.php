...
return [
    false, // $matchHost
    [ // $staticRoutes
        '/json-response' => [[['_route' => 'app_basic_jsonresponse', '_controller' => 'App\\Controller\\BasicController::jsonResponse'], null, null, null, false, false, null]],
        ...
        '/messages' => [[['_route' => 'message_list', '_controller' => 'App\\Controller\\MessageController::list'], null, null, null, false, false, null]],
    ...
    [ // $dynamicRoutes
        ...
        230 => [[['_route' => 'app_creeavecmake_message', '_controller' => 'App\\Controller\\CreeAvecMakeController::message'], ['id'], null, null, false, true, null]],
        248 => [[['_route' => 'message_item', '_controller' => 'App\\Controller\\MessageController::item'], ['id'], null, null, false, true, null]],
        289 => [[['_route' => 'app_routingchallenge_sendresult', '_controller' => 'App\\Controller\\RoutingChallengeController::sendResult'], ['id'], ['POST' => 0], null, false, true, null]],
        334 => [[['_route' => 'app_routingchallenge_getuseranswers', '_controller' => 'App\\Controller\\RoutingChallengeController::getUserAnswers'], ['username', '_format'], ['GET' => 0], null, false, true, null]],
        356 => [[['_route' => 'app_routingchallenge_getuseranswer', 'id' => 1, '_controller' => 'App\\Controller\\RoutingChallengeController::getUserAnswer'], ['username', 'id'], null, null, false, true, null]],
        ...
        463 => [[['_route' => '_profiler_search_results', '_controller' => 'web_profiler.controller.profiler::searchResultsAction'], ['token'], null, null, false, false, null]],
        477 => [[['_route' => '_profiler_router', '_controller' => 'web_profiler.controller.router::panelAction'], ['token'], null, null, false, false, null]],
        497 => [[['_route' => '_profiler_exception', '_controller' => 'web_profiler.controller.exception_panel::body'], ['token'], null, null, false, false, null]],
        510 => [[['_route' => '_profiler_exception_css', '_controller' => 'web_profiler.controller.exception_panel::stylesheet'], ['token'], null, null, false, false, null]],
        520 => [[['_route' => '_profiler', '_controller' => 'web_profiler.controller.profiler::panelAction'], ['token'], null, null, false, true, null]],
        553 => [
